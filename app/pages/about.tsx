  ...
  return (
    <div className=" max-w-7xl mx-auto px-4">
      ...
      <h3 className="md:text-xl text-sm lg:text-xl font-medium text-left relative z-20 text-gray-400 max-w-7xl pb-8 lg:mb-4 pl-4 pr-4">
        <p>
          Hello, I&apos;m Muhammad Irfa' Maulana{" "}
        </p>
        <p className="mt-6">
          With <span className="text-white">1 years </span>
          of experience as a <span className="text-white"></span>
          <span className="text-white">Web Developer</span>, I specialize
          in <span className="text-white"></span>Backend Developer.
        </p>
        <p className="mt-6">
          ...
          <Tooltip
            text="Laravel and React ecosystems"
        ...
        <p className="mt-6">
          ...
          <span className="text-white">The Yezzpay</span>, a leading{" "}
          <span className="text-white">Indonesia company</span> known for innovative
          solutions.
        </p>
        <p className="mt-6">
